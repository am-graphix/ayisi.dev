...
export const posts = [
  {
    ...
    content:
      'The first time I joined the robotics club in Form 1, I thought I was going to learn how to build robots.\n\nThat\'s not quite what happened.\n\nI did learn to build robots. But more than that, I learnt various strategies to position your eye to see through problems, which equally mattered as building robots\n\nI figured out robotics is not necessarily about the robots... It is more about the cause of their existence, and much their existence has contributed to their cause.. The robots however, are medium of execution.\n\n Upon realising that, my whole focus in robotics shifted towards problem solving... It shocks me how I get overjoyed when I am able to figure out a solution to a problem I might have no idea on how I am going to implement it, I mostly do not even have the skills required to implement my solution. \n\n Clearly figuring out an ideal solution feels like I\'ve gotten it all... \n\n To be realistic, figuring out a solution to a problem does not guarantee the problem\'s extinction... Searching out the best of numerous raw materials of executing your solution is the most rewarding headache of all... \n\nIn all the projects I have built, I never had the skills to execute any of them at the time I decided I was going to build... However, this skill I consider to be the greatest above all, was the only skill I had, prior to every build.. \n\nI am talking about the mindset to go every mile to get the job done... \n\nTrust me, its rarer than you think... It pushed me to learn everything I know how to do... And I never learned any skill because I had passion, or I just wanted to, I learned because I needed to use it.. \n\nWhat robotics taught me the HARDEST way however; Coordinating a team when everyone has an opinion and a deadline is pressing. Presenting a thing you built to people who didn\'t build it and make them care about it anyway. Thats a topic for another post...🔥\n\nThe robots were the excuse. The real curriculum was everything else.',
  },
]
// ─── Mike system prompt ───────────────────────────────────────
